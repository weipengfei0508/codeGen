...
public class TableModel implements Serializable{
	...
	private String java_column_name;//映射到java中的名称
	...
	public TableModel(String columnName,String javaColumnName, String isNullable, String extra,
		...
		this.java_column_name=javaColumnName;
	...
	public String getJava_column_name() {
		return java_column_name;
	}



	public void setJava_column_name(String java_column_name) {
		this.java_column_name = java_column_name;
	}
