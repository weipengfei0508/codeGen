 ...
 * @version 2013-03-15
 */
public class PgGenerate {

	private static Logger logger = LoggerFactory.getLogger(PgGenerate.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String datebase="zrt_ef_3";
		PgProvider dbProvider = new PgProvider(jdbcConfig);
		
		
		String classAuthor = "zrt"; // 类作者
		// 生成代码所在的包
		String packageName = "com.zrt";
		// 单张表生成代码
		String moduleName = "plate"; // 模块名，例：sys
		String tablename = "plate_data"; // 表名
		String functionName = "车牌入库"; // 功能名，例：用户
